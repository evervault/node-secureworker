...
SecureWorker._sandboxContext = function _sandboxContext(secureWorker, contentKey) {
  ...
  var sandbox = {
    ...
    SecureWorker: {
      ...
      // In trusted environment on the server, self.importScripts assures that
