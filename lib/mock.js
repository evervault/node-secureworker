  ...
  var sandbox = {
    ...
    SecureWorker: {
      ...
      getReport: function getReport(targetInfo, reportData) {
        return SecureWorker._getReport(secureWorker._vmGlobalContext, targetInfo, reportData);
      }
    },
...
SecureWorker._getReport = function _getReport(context, targetInfo, reportData) {
  if (!(targetInfo instanceof context.ArrayBuffer && targetInfo.byteLength === 512)) throw new context.Error("Invalid target info.");
